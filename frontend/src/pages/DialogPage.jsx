...
const DialogPage = () => {
    ...
    const handleSendSelfMessage = () => {
        const newDialog = {
            id: Date.now(),
            client: "Вы сами",
            source: "Тест",
            lastMessage: "Привет себе!",
            time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
            messages: [
                { sender: "Вы", text: "Привет себе!", time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) }
            ]
        };
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen bg-[#e6e5ea] overflow-hidden">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                <header className="w-full p-4 flex flex-col md:flex-row md:justify-between items-start md:items-center gap-3 md:gap-0 mt-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        <button className="border-[#2a4992] border-2 bg-white px-4 py-1 rounded-full text-[#4b5563] hover:bg-[#2a4992] hover:text-white">
                            Фильтрация
                        </button>
                        <input
                            type="text"
                ...
                {!isLoading && dialogs.length > 0 ? (
                    ...
                    <main className="flex-1 p-8">
                        ...
                        <div className="flex justify-center mt-10">
                            <button className="bg-[#092155] text-white px-6 py-2 rounded-full shadow-[14px_14px_15px_rgba(0,0,0,0.32)] hover:bg-[#2a4992] active:bg-[#dadee7] active:text-black transition-all transform active:scale-95">
