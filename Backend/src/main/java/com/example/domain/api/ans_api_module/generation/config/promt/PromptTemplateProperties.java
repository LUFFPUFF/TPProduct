package com.example.domain.api.ans_api_module.generation.config.promt;

import com.example.domain.api.ans_api_module.generation.config.yaml.YamlPropertySourceFactory;
import lombok.Data;
