package com.example.domain.api.chat_service_api.integration.manager.mail.manager;

import com.example.database.model.company_subscription_module.company.CompanyMailConfiguration;
import com.example.domain.api.chat_service_api.integration.manager.mail.parser.AbstractEmailParser;
import com.example.domain.api.chat_service_api.integration.manager.mail.parser.GmailParser;
import com.example.domain.api.chat_service_api.integration.manager.mail.parser.YandexParser;
