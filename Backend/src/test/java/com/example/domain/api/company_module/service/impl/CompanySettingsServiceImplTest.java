...
// import com.example.domain.api.company_module.service.CompanySettingsService; // Не нужен для теста реализации
...
@MockitoSettings(strictness = Strictness.LENIENT) // Строгость не так важна для заглушек
class CompanySettingsServiceImplTest {

    @Mock
    private CompanyRepository companyRepository; // Зависимость должна быть замокана
    ...
    void changeName_ShouldReturnNull_AsPerCurrentImplementation() {
        ...
        // На данный момент нет взаимодействий с companyRepository для этого метода
